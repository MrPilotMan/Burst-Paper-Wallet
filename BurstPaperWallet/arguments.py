...
def arguments():
    ...
    parser.add_argument("-p", "--passphrase", action="store_true", help="Passphrase to use for paper wallet."
    ...
    parser.add_argument("-i", "--initialize", action="store_true", help="Send transaction to broadcast "
